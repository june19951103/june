...
4) MX(Mail Exchange) : 메일서버에 도달할 수 있는 라우팅 정보를 제공합니다.
5) SOA(Start Of Authority) : DNS 영역의 주 DNS 서버 정의 및 refresh, retry 간격 등을 정의합니다.
6) PTR(PoinTeR) : 역방향 조회에서 A레코드를 가리킬 때 사용합니다.
